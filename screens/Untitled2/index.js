...
const Untitled2 = ({
  ...
  return <SafeAreaView style={styles.safeArea}>
    ...
    <View style={styles.UAsmEBAo}><ImageBackground style={styles.ZfIrCuaA} source={{
      ...
      }} resizeMode="cover"></ImageBackground><Pressable onPress={() => navigation.navigation.navigate("undefined", {})}><View style={styles.UMwHEUhC} onPress={() => navigation.navigation.navigate("undefined", {})}><Text style={styles.AFAUcFgP}>Test</Text></View></Pressable></View></SafeAreaView>;
};
