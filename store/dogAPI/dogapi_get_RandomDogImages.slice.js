...
export const dogapi_get_breeds_image_random_read = createAsyncThunk("dogapi_get_RandomDogImages/dogapi_get_breeds_image_random_read", async payload => {
  const response = await apiService.dogapi_get_breeds_image_random_read(payload);
